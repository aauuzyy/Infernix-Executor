      ...
      try {
        ...
        if (updateInfo.hasUpdate && updateInfo.downloadUrl) {
          ...
          const result = await dialog.showMessageBox(mainWindow, {
            ...
            message: 'Infernix v' + updateInfo.latestVersion + ' is available!',
            detail: 'A new version of Infernix is available. Click Update to download the latest version.\n\nChanges:\n' + (updateInfo.releaseNotes || 'See release notes on GitHub'),
